...
| Interactive alias review | `paused` | [interactive-alias-review.md](interactive-alias-review.md) | Paused — terminal flow superseded by browser-based `review-new-characters` admin UI (`/admin/.../review/new-characters`). |
