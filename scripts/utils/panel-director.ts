...
// ─── Effect / audio tag enums (single source of truth) ────────────────────────
//
// Adding a tag: append to the appropriate array, expose in the prompt, and add
// the matching renderer component (effects) or library audio file (audio tags).
